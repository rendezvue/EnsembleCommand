...
enum Comand
{
	...
	ENSEMBLE_CAMERA_SET_AUTO_EXPOSURE_ONOFF,
	ENSEMBLE_CAMERA_GET_AUTO_EXPOSURE_ONOFF,
	...
	ENSEMBLE_CAMERA_SET_AUTO_FOCUS_ONOFF,
	ENSEMBLE_CAMERA_GET_AUTO_FOCUS_ONOFF,
